...
namespace UnsecuredAPIKeys.Providers._Base
{
    ...
    public abstract class BaseApiKeyProvider(ILogger? logger = null) : IApiKeyProvider
    {
        ...
        private IReadOnlyList<Regex>? _compiledRegexes;
        ...
        /// <summary>
        /// Gets pre-compiled regex instances, lazily created on first access.
        /// </summary>
        public IReadOnlyList<Regex> CompiledRegexes =>
            _compiledRegexes ??= RegexPatterns
